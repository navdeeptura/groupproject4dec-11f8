[groupproject4dec-11f8] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [groupproject4dec-11f8] container is NOT running**.

.. tip::
   You must have your [groupproject4dec-11f8] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/navdeeptura/raspberrypi/blob/main/tml-airflow/logs/logs.txt
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/navdeeptura/raspberrypi  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=34911  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='navdeeptura'  \-\-env DOCKERUSERNAME='navdeeptura'  \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   navdeeptura/groupproject4dec-11f8-amd64 (https://hub.docker.com/r/navdeeptura/groupproject4dec-11f8-amd64)
...
.. code-block::
   ...
   docker run -d -p 44563:44563 -p 59509:59509 -p 52789:52789 -p 8883:8883 \
          --env TSS=0 \
          --env SOLUTIONNAME=groupproject4dec-11f8 \
          --env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-groupproject4dec-11f8 \
          --env GITUSERNAME=navdeeptura \
          --env GITREPOURL=https://github.com/navdeeptura/raspberrypi \
          --env SOLUTIONEXTERNALPORT=44563 \
          -v /var/run/docker.sock:/var/run/docker.sock:z  \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=59509  \
          --env SOLUTIONVIPERVIZPORT=52789 \
          --env DOCKERUSERNAME='navdeeptura' \
          --env CLIENTPORT=8883  \
          --env EXTERNALPORT=34911 \
          --env KAFKACLOUDUSERNAME='' \
          --env VIPERVIZPORT=9005 \
          ...
          navdeeptura/groupproject4dec-11f8-amd64
...
[groupproject4dec-11f8] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/navdeeptura/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/groupproject4dec-11f8
...
.. important::
   https://groupproject4dec-11f8.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-groupproject4dec-11f8
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=44563, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=39245, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=33721, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=39461, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=46045, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=46109, HPDEHOST=127.0.1.1, HPDEPORT=33877, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=36165

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-4999-groupproject4dec-11f8,solution_preprocessing_ai_mqtt_dag-groupproject4dec-11f8, python-preprocess-9418-groupproject4dec-11f8,solution_preprocessing_ai_mqtt_dag-groupproject4dec-11f8, python-ai-6031-groupproject4dec-11f8,solution_preprocessing_ai_mqtt_dag-groupproject4dec-11f8, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
